            ...
            <div className="hidden md:flex items-center space-x-6">
              {isLoggedIn ? (
                <div className="flex items-center space-x-6">
                    ...
                    <span className="text-base font-bold text-gray-200 group-hover:text-white transition-colors">{user?.name?.split(' ')[0] || "User"}</span>
                  </Link>
                  <button
            ...
            {isLoggedIn ? (
              <div className="p-4 bg-blue-900/20 rounded-2xl border border-blue-500/20">
                <div className="flex items-center space-x-3 mb-4">
                  <Image src={user?.profileImg || "https://cdn-icons-png.flaticon.com/512/149/149071.png"} alt="profile" width={40} height={40} className="rounded-full" />
                  <div>
